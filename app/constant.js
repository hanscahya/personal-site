...
export const expertises = [
  ...
  {
    label: 'Product mangagement apps',
    items: [
      'Github & Gitlab',
      'Figma',
      'Lark, Slack',
...
export const educations = [
  ...
  {
    time: '2010 - 2013',
    title: 'Dwiwarna Boarding School',
    lists: [
...
export const careers = [
  {
    time: 'Feb, 2016 - Sep, 2018',
    title: 'Full-stack Engineer at W3Ocean',
    lists: [
  ...
  },
  {
    ...
    title: 'Co-Founder at Starguides Co.',
    lists: [
  ...
  },
  {
    ...
    title: 'Frontend Engineer at Flitts',
    lists: [
  ...
  {
    time: 'Des, 2021 - Sep, 2022',
    title: 'as Lead Frontend Engineer',
    lists: [
      'Promoted by CTO, I led frontend development process with the focus on accelerating feature delivery.',
      'Also to improve team development process, and has resulted in notable achievements: Established FE development guidelines, significantly reducing code conflicts and complexity. This led to a noticeable increase in on-time feature delivery.; Built trust among engineers through clear standards and collaboration.; Lead the Nuxt 3 migration plan, modernizing our tech stack for better performance and efficiency.',
    ],
  },
  {
    time: 'Oct, 2022 - Des, 2023',
    title: 'as Frontend Engineer',
    lists: [
      'During a period of company restructuring, I demonstrated loyalty and adaptability by stepping back from my leadership role and focusing on hands-on development.',
      'I remained committed to delivering essential frontend features and enhancements, driving the platform\'s crucial transition from Nuxt 2 to Nuxt 3.',
      'This migration ensures greater security and performance, aligning my work with the company\'s goals.',
    ],
  },
  {
    time: 'Jan, 2024 - Present',
    title: 'as (Solo) Frontend Engineer',
    lists: [
      'Despite further company challenges, I remained highly committed, signify my determination to drive positive outcomes for the frontend.',
      'Our internal-facing app has fully transitioned to Nuxt 3, and I\'m actively working the migration of our client-facing app.',
      'This phase also offers the exciting opportunity to expand my expertise by working on our scoring engine app.',
      'I\'ve embraced TypeScript for its superior code clarity and maintainability.',
    ],
  },
];
export const sideProjects = [
  ...
  },
  {
    ...
    title: 'Tropical Cyclone site, BMKG',
    lists: [
  ...
  {
    time: 'Jul, 2022 - Mar, 2023',
    title: 'Project Monitoring, internal BCA',
    lists: [
